...
export default function Footer() {
  ...
  return (
    <footer className='pb-16 pt-10 bg-gray-900 text-white'>
      <div className='container lg:px-12'>
        <div className='flex justify-between flex-col md:flex-row flex-wrap gap-[30px]'>
          <div>
          <div className='flex items-center gap-2'>
            <img src={logo} className=' max-w-12'></img>
            <h1 className=' text-3xl py-5 font-bold'>AstraNex</h1>
          </div>
            <p className='text-[18px] leading-7 font-[400]'>
              Copyright © {year} Developed by Null Ninzas all right reserved.
            </p>
